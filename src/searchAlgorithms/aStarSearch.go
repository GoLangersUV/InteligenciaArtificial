...
// Less returns true if element i has a lower F value than element j
...
// Pop removes and returns the node with the lowest F value
...
func (a *AStarSearch) LookForGoal(env *Environment) SearchResult {
    ...
    for openList.Len() > 0 {
        ...
        // Check if we have reached the goal and have the passenger
    ...
    for _, dir := range directions {
        ...
        if newX >= 0 && newX < 10 && newY >= 0 && newY < 10 {
            ...
            if cellValue != WALL {
                ...
                // Determine if we have picked up the passenger
